...
func (c *Client) AttachProgramWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAttachProgramRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AttachProgram(ctx context.Context, body AttachProgramJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewAttachProgramRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewAttachProgramRequest(server string, body AttachProgramJSONRequestBody) (*http.Request, error) {
	...
	return NewAttachProgramRequestWithBody(server, "application/json", bodyReader)
}

// NewAttachProgramRequestWithBody generates requests for AttachProgram with any type of body
func NewAttachProgramRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func (r AttachProgramResponse) Status() string {
...
func (r AttachProgramResponse) StatusCode() int {
	if r.HTTPResponse != nil {
...
func (c *ClientWithResponses) AttachProgramWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*AttachProgramResponse, error) {
	rsp, err := c.AttachProgramWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) AttachProgramWithResponse(ctx context.Context, body AttachProgramJSONRequestBody, reqEditors ...RequestEditorFn) (*AttachProgramResponse, error) {
	rsp, err := c.AttachProgram(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseAttachProgramResponse(rsp)
...
func ParseAttachProgramResponse(rsp *http.Response) (*AttachProgramResponse, error) {
